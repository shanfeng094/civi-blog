Monologue.config do |config|
  config.site_name = "Civipush blog"
  config.site_subtitle = "闪枫阁"
  ...
  #SOCIAL
  config.twitter_username = "civipush"
  config.facebook_url = "https://www.facebook.com/civipush"
  config.facebook_logo = 'logo.png'
  config.google_plus_account_url = "https://plus.google.com/u/1/.../posts"
  config.linkedin_url = "http://www.linkedin.com/in/civipush"
  config.github_username = "civipush"
